...
public final class C1882ik implements InterfaceC0070Be.a {
    ...
    public C1882ik(C1694ek c1694ek, List list, int i, C2287ra c2287ra, Request request, int i2, int i3, int i4) {
    ...
    public static C1882ik m7967d(C1882ik c1882ik, int i, C2287ra c2287ra, Request request, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = c1882ik.f5819d;
        }
        if ((i5 & 2) != 0) {
        ...
        return c1882ik.m7968c(i, c2287ra2, request2, i6, i7, i4);
    }

    @Override
    public Request mo303a() {
        return this.f5821f;
    }

    @Override
    public Response mo304b(Request request) {
        AbstractC0116Ce.m476e(request, "request");
        ...
        if (c2287ra != null) {
            if (!c2287ra.m9369j().m9699g(request.getUrl())) {
        ...
        C1882ik c1882ikM7967d = m7967d(this, this.f5819d + 1, null, request, 0, 0, 0, 58, null);
        InterfaceC0070Be interfaceC0070Be = (InterfaceC0070Be) this.f5818c.get(this.f5819d);
        Response responseMo302A = interfaceC0070Be.mo302a(c1882ikM7967d);
        if (responseMo302A == null) {
        ...
        if (responseMo302A.body() != null) {
            return responseMo302A;
        }
        throw new IllegalStateException(("interceptor " + interfaceC0070Be + " returned a response with no body").toString());
    }

    public final C1882ik m7968c(int i, C2287ra c2287ra, Request request, int i2, int i3, int i4) {
        AbstractC0116Ce.m476e(request, "request");
        return new C1882ik(this.f5817b, this.f5818c, i, c2287ra, request, i2, i3, i4);
    }
