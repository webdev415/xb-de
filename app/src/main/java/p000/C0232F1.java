...
public class C0232F1 implements InterfaceC0094C1 {
    ...
    public class a implements InterfaceC0556M3 {
        ...
        @Override
        public void mo1180a(InterfaceC0418J3 interfaceC0418J3, Response response) throws IOException {
            if (response.getStatus() == 200) {
                C0232F1.this.m1179o(ResourceCacheManager.getInstance().getUrlOrFilePath(this.f616b, this.f617c), response, this.f615a);
            } else {
                d dVar = this.f615a;
                if (dVar != null) {
                    dVar.mo845b();
    ...
    public class b implements InterfaceC0556M3 {
        ...
        public void mo1180a(InterfaceC0418J3 interfaceC0418J3, Response response) throws IOException {
            ...
            String strM468w = NetworkUtils.generateFileName(this.f620b, null, response.getContentType("Content-Type"));
            ...
            C0232F1.this.m1179o(strM4234r, response, this.f619a);
        }
    ...
    public class c implements InterfaceC0556M3 {
        ...
        public void mo1180a(InterfaceC0418J3 interfaceC0418J3, Response response) {
            ...
            try {
                try {
                    String strM1177m = C0232F1.this.getMimeTypeForUrl(this.f626c, response.getContentType("Content-Type"));
                    String strM2046a = ResourceCacheManager.getInstance().getUrlOrFilePath(this.f627d, 1);
                    if (strM1177m != null) {
                        if (strM1177m.indexOf("image/") >= 0) {
                            FileUtils.writeBytesToFile(response.body().m2709b(), strM2046a);
                            Drawable drawableM4399i = C0988Vd.getInstance().m4399i(strM2046a, SharedPreferencesHelper.getInstance().homeIconStyle);
                            ...
                            String strM2714l2 = response.body().m2714l();
                            if (response.getStatus() == 200) {
    ...
    public void mo364a(String str, boolean z, InterfaceC2229q7 interfaceC2229q7, HashMap map) {
        ...
        if (!z || !FileUtils.fileExists(strM2046a) || map != null) {
            ...
            this.httpClient.newCall(new Request.Builder().url(strM1176k).m500b()).mo1791i(new c(interfaceC2229q7, interfaceC2183p7M9356i, strM1176k, str));
            return;
        }
        if (!interfaceC2183p7M9356i.mo9041h(interfaceC2183p7M9356i.mo9037c() == 3 ? C0988Vd.getInstance().m4399i(strM2046a, SharedPreferencesHelper.getInstance().homeIconStyle) : FileUtils.readFileToString(strM2046a), interfaceC2183p7M9356i.mo9037c())) {
            if (interfaceC2229q7 != null) {
    ...
    public void m1172g(String str, String str2, String str3, String str4, String str5, d dVar) {
        ...
        if (str4.startsWith("http")) {
            Request.Builder builderVarM507I = new Request.Builder().url(str4);
            if (str3 != null) {
                try {
                    builderVarM507I.addHeader("User-Agent", str3);
            ...
            this.httpClient.newCall(builderVarM507I.m500b()).mo1791i(new b(dVar, str4, str5, str));
            return;
        }
    ...
    public void m1175j(String str, d dVar, int i) {
        ...
        builderVarM507I.addHeader("User-Agent", strM6849D);
        this.httpClient.newCall(builderVarM507I.m500b()).mo1791i(new a(dVar, str, i));
    }
    ...
    public final void m1179o(String str, Response response, d dVar) throws IOException {
        FileUtils.ensureParentDirsExist(str);
        String strM2399p = response.getContentType("Content-Type");
        InputStream inputStreamM2708a = response.body().byteStream();
