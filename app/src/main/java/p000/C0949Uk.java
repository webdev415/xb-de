...
public final class C0949Uk implements InterfaceC0070Be {
    ...
    */
    public Response mo302a(InterfaceC0070Be.a r11) {
        /*
            r10 = this;
        ...
        L5e:
            ...
            return r7
        L6e:
            Lk r0 = r7.body()     // Catch: java.lang.Throwable -> L42
            if (r0 == 0) goto L77
    ...
    public final Request m4269b(Response response, String str) {
        String strM2383w;
        C0069Bd c0069BdM256o;
        AbstractC0168Dk abstractC0168DkM490a = null;
        if (!this.f2863a.m1998s() || (strM2383w = Response.m2383w(response, "Location", null, 2, null)) == null || (c0069BdM256o = response.getRequest().getUrl().m256o(strM2383w)) == null) {
            return null;
        }
        if (!AbstractC0116Ce.m472a(c0069BdM256o.m257p(), response.getRequest().getUrl().m257p()) && !this.f2863a.m1999t()) {
            return null;
        }
        Request.Builder builderVarM497H = response.getRequest().m497h();
        if (C0023Ad.m117a(str)) {
            ...
            if (c0023Ad.m119b(str) && iM2396j != 308 && iM2396j != 307) {
                ...
                abstractC0168DkM490a = response.getRequest().m490a();
            }
            builderVarM497H.m503e(str, abstractC0168DkM490a);
            if (!z) {
                builderVarM497H.m505g("Transfer-Encoding");
                builderVarM497H.m505g("Content-Length");
                builderVarM497H.m505g("Content-Type");
            }
        }
        if (!AbstractC2623yo.m10932g(response.getRequest().getUrl(), c0069BdM256o)) {
            builderVarM497H.m505g("Authorization");
        }
        return builderVarM497H.m506h(c0069BdM256o).m500b();
    }

    public final Request m4270c(Response response, C2287ra c2287ra) throws ProtocolException {
        Connection connectionM9367H;
        Route routeM7637Z = (c2287ra == null || (connectionM9367H = c2287ra.m9367h()) == null) ? null : connectionM9367H.m7637z();
        int iM2396j = response.getStatus();
        String strM496g = response.getRequest().m496g();
        if (iM2396j != 307 && iM2396j != 308) {
            if (iM2396j == 401) {
                return this.f2863a.m1987c().mo2575a(routeM7637Z, response);
            }
            if (iM2396j == 421) {
                AbstractC0168Dk abstractC0168DkM490a = response.getRequest().m490a();
            ...
            if (iM2396j == 503) {
                Response responseM2387E = response.m2387E();
                if ((responseM2387E == null || responseM2387E.getStatus() != 503) && m4274g(response, Integer.MAX_VALUE) == 0) {
                    return response.getRequest();
                }
                return null;
            }
            if (iM2396j == 407) {
                AbstractC0116Ce.m473b(routeM7637Z);
                if (routeM7637Z.getProxy().type() == Proxy.Type.HTTP) {
                    return this.f2863a.m1979C().mo2575a(routeM7637Z, response);
                }
            ...
            if (iM2396j == 408) {
                ...
                AbstractC0168Dk abstractC0168DkM490a2 = response.getRequest().m490a();
                if (abstractC0168DkM490a2 != null && abstractC0168DkM490a2.m723g()) {
                    return null;
                }
                Response responseM2387E2 = response.m2387E();
                if ((responseM2387E2 == null || responseM2387E2.getStatus() != 408) && m4274g(response, 0) <= 0) {
                    return response.getRequest();
                }
                return null;
            }
        ...
        return m4269b(response, strM496g);
    }
    ...
    public final boolean m4272e(IOException iOException, C1694ek c1694ek, Request request, boolean z) {
        if (this.f2863a.m1982F()) {
            return !(z && m4273f(iOException, request)) && m4271d(iOException, z) && c1694ek.m7430B();
        }
        return false;
    }

    public final boolean m4273f(IOException iOException, Request request) {
    ...
    public final int m4274g(Response response, int i) throws NumberFormatException {
        String strM2383w = Response.m2383w(response, "Retry-After", null, 2, null);
        if (strM2383w == null) {
            return i;
        }
