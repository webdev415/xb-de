...
public final class C2379ta {
    ...
    public C1328bl f7212f;

    public final C1835hk f7213g;

    public final C2498w0 f7214h;

    public final C1694ek f7215i;

    public final AbstractC1918ja f7216j;

    public C2379ta(C1835hk c1835hk, C2498w0 c2498w0, C1694ek c1694ek, AbstractC1918ja abstractC1918ja) {
    ...
    */
    public final C1741fk m9694b(int r15, int r16, int r17, int r18, boolean r19) throws IOException {
        /*
    ...
    public final C1741fk m9695c(int i, int i2, int i3, int i4, boolean z, boolean z2) throws IOException {
        while (true) {
            C1741fk c1741fkM9694b = m9694b(i, i2, i3, i4, z);
            if (c1741fkM9694b.m7632u(z2)) {
                return c1741fkM9694b;
            }
            c1741fkM9694b.m7636y();
            if (this.f7212f == null) {
    ...
    public final boolean m9697e() {
        ...
        C1328bl c1328blM9698f = m9698f();
        if (c1328blM9698f != null) {
            this.f7212f = c1328blM9698f;
            return true;
        }
        C1742fl.b bVar = this.f7207a;
    ...
    public final C1328bl m9698f() {
        C1741fk c1741fkM7443o;
        if (this.f7209c > 1 || this.f7210d > 1 || this.f7211e > 0 || (c1741fkM7443o = this.f7215i.m7443o()) == null) {
            return null;
        }
        synchronized (c1741fkM7443o) {
            if (c1741fkM7443o.m7628q() != 0) {
                return null;
            }
            if (AbstractC2623yo.m10932g(c1741fkM7443o.m7637z().m5675a().m10421l(), this.f7214h.m10421l())) {
                return c1741fkM7443o.m7637z();
            }
            return null;
        }
    }
